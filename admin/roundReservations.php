...
JOIN ticketdetails v ON p.Ticket_ID = v.Ticket_ID WHERE p.Trip_Type="RoundTrip"';
...
<div class="col-sm-12 container-fluid top"> 
    <br>
        ...
        <H4 class="screen-mission">Round Trip Reservations</H4>
        <a href="reservation.php"><button type="button"  class="btn btn-warning btn-lg">One Way Reservations</button></a>
    <br>
...
<table class="table table-striped table-inverse" style="color: black">
  ...
  <?php foreach ($reservations as $loc) : ?>
    <tr>
      ...
      <td><?php echo $loc['Return_Date']; ?></td>
